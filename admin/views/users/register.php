    <div class="card mb-0 shadow-none">
        <div class="card-body">
            ...
            <div class="px-2 mt-2">
                ...
                <p class="text-muted text-center">Get your free LP Shop account now.</p>
                ...
                <form class="form-horizontal my-4" action="" method="post">
                    ...
                    <div class="form-group mb-0 row">
                        <div class="col-12 mt-2">
                            <button class="btn btn-primary btn-block waves-effect waves-light" name="submit" type="submit">Register <i class="fas fa-sign-in-alt ml-1"></i></button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="m-2 text-center bg-light p-4 text-primary">
                ...
                <a href="index.php?controller=login&action=login" class="btn btn-primary waves-effect waves-light">Log In</a>
            </div>
